...
export const metadata: Metadata = {
    title: "Médiathèque & Blog",
    description: "Retrouvez nos articles, vidéos et audios pour enrichir vos connaissances et suivre nos actualités.",
};
        ...
        <div className="flex flex-col gap-12 pb-16">
            ...
            <section className="bg-muted/30 py-16">
                <div className="container mx-auto px-4 text-center space-y-4">
                    <h1 className="text-4xl font-bold font-serif text-primary">Médiathèque & Blog</h1>
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                        Retrouvez nos articles, vidéos et audios pour enrichir vos connaissances et suivre nos actualités.
                    </p>
                </div>
            </section>
            ...
            <section className="container mx-auto px-4">
                {posts.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {posts.map((post: any) => (
                            <Card key={post.id} className="overflow-hidden hover:shadow-lg transition-shadow group flex flex-col h-full">
                                <div className="relative h-48 overflow-hidden shrink-0 bg-muted flex items-center justify-center">
